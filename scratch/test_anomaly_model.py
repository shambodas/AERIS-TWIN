...
# Create a feature vector similar to what was generated during the test
features = {
    "rpm": 3000.0,
    "throttle_pct": 50.0,
    "altitude_m": 0.0,
...
print("Model score:", detector._score_from_model(features))
print("Fallback score:", detector.score(features) if detector.model is None else "N/A (bypassed)")

# Let's force fallback by unsetting model
detector.model = None
print("Fallback score if model is None:", detector.score(features))
